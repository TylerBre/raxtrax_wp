...
/**
*
* You gotta register the post types to get pretty permalinks. YOU JUST GOTTA.
*
**/
...
// register_post_type('studios', array(
//   'rewrite' => array('slug'=>'studios','with_front' => false),
// ));
...
// removes some un-needed navigation items from the dashboard. Good riddance.
function remove_menus () {
    ...
    // this is fucking garbage. shame on whoever wrote this.
    while (prev($menu)){
